<?php
    ...
    $error = false;
    $fname = $lname = $email = $date_of_birth = $pass = '';
...
<body>
   <div class="container">
   <form class="w-75 bg-dark" method="post" action="<?php echo htmlspecialchars($_SERVER['PHP_SELF']); ?>" autocomplete="off" enctype="multipart/form-data">
            <h2>Sign Up.</h2>
            <hr/>
            <?php
            if (isset($errMSG)) {
